                        ...
                        <tbody>
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($sizesDetails[$product->id] as $sizeDetail)
                                            {{$sizeDetail['size']}}<br>
                                        @endforeach
                                    </td>
                                    ...
                                    <td>
                                        @if ($productQuantities[$product->id] > 0)
                                            <span class="badge badge-primary">{{ $productQuantities[$product->id] }}</span>
                                        @else
                                            <span class="badge badge-danger">{{ $productQuantities[$product->id] }}</span>
                                        @endif
                                    </td>
                                    <td>
