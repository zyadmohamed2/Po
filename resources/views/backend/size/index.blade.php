...
@section('title','E-SHOP || Size Page')
          ...
          <tbody>
            @foreach($sizes as $size)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('size.edit',$size->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
